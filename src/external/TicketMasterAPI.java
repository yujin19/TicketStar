...
//import entity.Item.ItemBuiler;


public class TicketMasterAPI {
	private static final String URL = "https://app.ticketmaster.com/discovery/v2/events.json";
	private static final String DEFAULT_KEYWORD = ""; // no restriction
	private static final String API_KEY = "gMBJ44GHGHvGq3bTrASiFi5qHFb4Z82D";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			// find its _embedded key's value is not null, go to get the value
...
//			}
	...
	/**
	 * @param event
	 * @return address to string only with city, exclude state, country
		...
		if (!event.isNull("_embedded")) {
			...
			if (!embedded.isNull("venues")) {
				...
				for (int i = 0; i < venues.length(); i++) {
					// only the first venue is what we need
					...
					if (!venue.isNull("city")) {
						...
						builder.append(",");
						builder.append(venue.getString("name"));
